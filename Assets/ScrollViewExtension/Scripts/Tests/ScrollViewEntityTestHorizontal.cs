...
{
    [TestFixture]
    public class ScrollViewEntityTestHorizontal
    {
        ...
        public void GetContentLength_SpecifiedItems_LengthIsCorrect()
        {
            ...
            instance.CreateItem(new Vector2(4.5f, 4.5f), new Vector2(4, 4));
        ...
        public void TestCalculateItemPosition()
        {
            ...
            containerView.CreateItem(new Vector2(54.12f, 54.12f), new Vector2(115, -115)); // Item 3
            containerView.CreateItem(new Vector2(60, 62.33f), new Vector2(179.12f, -179.12f)); // Item 4
            ...
            Assert.AreEqual(new Vector2(179.12f, -179.12f), containerView.CalculateItemPosition(4));
        }
